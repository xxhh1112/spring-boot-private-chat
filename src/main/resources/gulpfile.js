...
var buildLocation = '../../../target/classes/static';
var appLocation = './src/org/privatechat';
...
gulp.task(tasks.JS_VENDORS, function () {
  return gulp.src([
    ...
    npmLocation + '/jquery.cookie/jquery.cookie.js',
    npmLocation + '/bootstrap/dist/js/bootstrap.min.js',
    npmLocation + '/underscore/underscore-min.js'
  ])
...
gulp.task(tasks.CSS_VENDORS, function () {
  return gulp.src([
    npmLocation + '/bootstrap/dist/css/bootstrap.min.css',
  ])
